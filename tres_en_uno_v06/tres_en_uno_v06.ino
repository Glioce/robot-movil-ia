...
// v0.6 Cambio de sensor Sharp por Ultrasónico
...
//#define PIN_SHARP A0 //sensor sharp. Ya no se usa
...
void loop() {
  ...
  Serial.println(sonar.ping_cm()); //aquí se mide la distancia

  delay(5); //retardo entre loops
}
