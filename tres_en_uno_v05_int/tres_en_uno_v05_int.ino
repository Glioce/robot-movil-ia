...
// v0.5 int Agrega rutinas de interrupción para detectar el cambio de estado de los encoders

// definición de pines
#define PIN_E1 2 //encoder 1 (pines que pueden disparar interrupciones)
#define PIN_E2 3 //encoder 2
#define PIN_MI1 4  //motor izquierdo 1
#define PIN_MI2 5  //motor izquierdo 2
#define PIN_MD1 6  //motor derecho 1
#define PIN_MD2 7  //motor derecho 2
...
void isrEncoder1() {
  // código para cambio de estado en encoder 1
}
void isrEncoder2() {
  // código para cambio de estado en encoder 2
}
...
void setup() {
  ...
  attachInterrupt( digitalPinToInterrupt(PIN_E1), isrEncoder1, CHANGE);
  attachInterrupt( digitalPinToInterrupt(PIN_E2), isrEncoder2, CHANGE);
